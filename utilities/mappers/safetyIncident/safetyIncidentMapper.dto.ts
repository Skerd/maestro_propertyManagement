import type {SafetyIncident} from "armonia/src/modules/propertyManagement/api/realEstate/private/safetyIncident/safetyIncident.dto";
...
export function safetyIncidentToDTO(doc: ISafetyIncident | any): SafetyIncident {
    ...
    return out as SafetyIncident;
}

export function safetyIncidentsToDTO(docs: ISafetyIncident[]): SafetyIncident[] {
    return docs.map(safetyIncidentToDTO);
}
