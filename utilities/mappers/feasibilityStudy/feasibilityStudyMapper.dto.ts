import type {FeasibilityStudy} from "armonia/src/modules/propertyManagement/api/realEstate/private/feasibilityStudy/feasibilityStudy.dto";
...
export function feasibilityStudyToDTO(doc: IFeasibilityStudy | any): FeasibilityStudy {
    ...
    return out as FeasibilityStudy;
}

export function feasibilityStudysToDTO(docs: IFeasibilityStudy[]): FeasibilityStudy[] {
    return docs.map(feasibilityStudyToDTO);
}
