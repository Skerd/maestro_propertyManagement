import type {SiteDiary} from "armonia/src/modules/propertyManagement/api/realEstate/private/siteDiary/siteDiary.dto";
...
export function siteDiaryToDTO(doc: ISiteDiary | any): SiteDiary {
    ...
    return out as SiteDiary;
}

export function siteDiarysToDTO(docs: ISiteDiary[]): SiteDiary[] {
    return docs.map(siteDiaryToDTO);
}
