...
export const maintenancePlanSheetView: ViewConfig = {
    ...
    nodes: [{render: "#SheetGroup", props: {title: "overview"}, children: [{render: "#SheetGrid", props: {columns: 3}, children: [
        ...
        {render: "#SmallInfoCard", permissions: {read: "planType"}, dependent: "planType", field: {name: "planType", widget: "#SmallInfoCard", label: "planType", widgetProps: {icon: "#IconLabel", languageKeyCategory: "planTypes"}}},
        {render: "#SmallInfoCard", permissions: {read: "intervalDays"}, dependent: "intervalDays", field: {name: "intervalDays", widget: "#SmallInfoCard", label: "intervalDays", widgetProps: {icon: "#IconLabel"}}},
