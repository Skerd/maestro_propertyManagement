import type {ConstructionContract} from "armonia/src/modules/propertyManagement/api/realEstate/private/constructionContract/constructionContract.dto";
...
export function constructionContractToDTO(doc: IConstructionContract | any): ConstructionContract {
    ...
    return out as ConstructionContract;
}

export function constructionContractsToDTO(docs: IConstructionContract[]): ConstructionContract[] {
    return docs.map(constructionContractToDTO);
}
