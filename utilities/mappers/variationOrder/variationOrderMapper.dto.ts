import type {VariationOrder} from "armonia/src/modules/propertyManagement/api/realEstate/private/variationOrder/variationOrder.dto";
...
export function variationOrderToDTO(doc: IVariationOrder | any): VariationOrder {
    ...
    return out as VariationOrder;
}

export function variationOrdersToDTO(docs: IVariationOrder[]): VariationOrder[] {
    return docs.map(variationOrderToDTO);
}
