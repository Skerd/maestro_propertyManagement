            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "elementCode"}, dependent: "elementCode", field: {name: "elementCode", widget: "#SmallInfoCard", label: "elementCode", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#SmallInfoCard", permissions: {read: "wbsCode"}, dependent: "wbsCode", field: {name: "wbsCode", widget: "#SmallInfoCard", label: "wbsCode", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "plannedQty"}, dependent: "plannedQty", field: {name: "plannedQty", widget: "#SmallInfoCard", label: "plannedQty", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#SmallInfoCard", permissions: {read: "plannedRate"}, dependent: "plannedRate", field: {name: "plannedRate", widget: "#SmallInfoCard", label: "plannedRate", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "actualQty"}, dependent: "actualQty", field: {name: "actualQty", widget: "#SmallInfoCard", label: "actualQty", widgetProps: {icon: "#IconLabel"}}},
