import type {Budget} from "armonia/src/modules/propertyManagement/api/realEstate/private/budget/budget.dto";
...
export function budgetToDTO(doc: IBudget | any): Budget {
    ...
    return out as Budget;
}

export function budgetsToDTO(docs: IBudget[]): Budget[] {
    return docs.map(budgetToDTO);
}
