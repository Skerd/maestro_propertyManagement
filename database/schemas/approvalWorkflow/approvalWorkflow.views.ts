            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "approverRole"}, dependent: "approverRole", field: {name: "approverRole", widget: "#SmallInfoCard", label: "approverRole", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#SmallInfoCard", permissions: {read: "thresholdAmount"}, dependent: "thresholdAmount", field: {name: "thresholdAmount", widget: "#SmallInfoCard", label: "thresholdAmount", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#SmallInfoCard", permissions: {read: "thresholdCurrency"}, dependent: "thresholdCurrency", field: {name: "thresholdCurrency.abbreviation", widget: "#SmallInfoCard", label: "thresholdCurrency", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#SmallInfoCard", permissions: {read: "escalationRole"}, dependent: "escalationRole", field: {name: "escalationRole", widget: "#SmallInfoCard", label: "escalationRole", widgetProps: {icon: "#IconLabel"}}},
