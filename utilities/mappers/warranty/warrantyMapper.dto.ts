import type {Warranty} from "armonia/src/modules/propertyManagement/api/realEstate/private/warranty/warranty.dto";
...
export function warrantyToDTO(doc: IWarranty | any): Warranty {
    ...
    return out as Warranty;
}

export function warrantysToDTO(docs: IWarranty[]): Warranty[] {
    return docs.map(warrantyToDTO);
}
