...
export const NotificationEventCodes = {
    ...
    /** Staff watchers (PropertyManagementConfig.notifyOnReservations). */
    RESERVATION_CREATED_STAFF: "RESERVATION_CREATED_STAFF",
    ...
    /** Staff watchers (PropertyManagementConfig.notifyOnSales). */
    SALE_CREATED_STAFF: "SALE_CREATED_STAFF",
