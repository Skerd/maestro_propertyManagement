import type {BoqItem} from "armonia/src/modules/propertyManagement/api/realEstate/private/boqItem/boqItem.dto";
...
export function boqItemToDTO(doc: IBoqItem | any): BoqItem {
    ...
    return out as BoqItem;
}

export function boqItemsToDTO(docs: IBoqItem[]): BoqItem[] {
    return docs.map(boqItemToDTO);
}
