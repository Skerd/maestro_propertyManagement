import type {CommissioningRecord} from "armonia/src/modules/propertyManagement/api/realEstate/private/commissioningRecord/commissioningRecord.dto";
...
export function commissioningRecordToDTO(doc: ICommissioningRecord | any): CommissioningRecord {
    ...
    return out as CommissioningRecord;
}

export function commissioningRecordsToDTO(docs: ICommissioningRecord[]): CommissioningRecord[] {
    return docs.map(commissioningRecordToDTO);
}
