import type {ConsultantAppointment} from "armonia/src/modules/propertyManagement/api/realEstate/private/consultantAppointment/consultantAppointment.dto";
...
export function consultantAppointmentToDTO(doc: IConsultantAppointment | any): ConsultantAppointment {
    ...
    return out as ConsultantAppointment;
}

export function consultantAppointmentsToDTO(docs: IConsultantAppointment[]): ConsultantAppointment[] {
    return docs.map(consultantAppointmentToDTO);
}
