import type {WorkPackage} from "armonia/src/modules/propertyManagement/api/realEstate/private/workPackage/workPackage.dto";
...
export function workPackageToDTO(doc: IWorkPackage | any): WorkPackage {
    ...
    return out as WorkPackage;
}

export function workPackagesToDTO(docs: IWorkPackage[]): WorkPackage[] {
    return docs.map(workPackageToDTO);
}
