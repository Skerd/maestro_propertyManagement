            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#DisplayCard", permissions: {read: "total"}, dependent: "total", field: {name: "total", widget: "#DisplayCard", label: "total", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#DisplayCard", permissions: {read: "submittedAt"}, dependent: "submittedAt", field: {name: "submittedAt", widget: "#DisplayCard", label: "submittedAt", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "coveringNotes"}, dependent: "coveringNotes", field: {name: "coveringNotes", widget: "#DisplayCard", label: "coveringNotes", widgetProps: {icon: "#IconLabel"}}},
