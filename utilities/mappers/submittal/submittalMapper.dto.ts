import type {Submittal} from "armonia/src/modules/propertyManagement/api/realEstate/private/submittal/submittal.dto";
...
export function submittalToDTO(doc: ISubmittal | any): Submittal {
    ...
    return out as Submittal;
}

export function submittalsToDTO(docs: ISubmittal[]): Submittal[] {
    return docs.map(submittalToDTO);
}
