...
export const costCommitmentSheetView: ViewConfig = {
    ...
    header: {titleField: "title", subtitleKey: "costCommitment", showCloseButton: true},
    nodes: [
        {
            render: "#SheetGroup",
            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#DisplayCard", permissions: {read: "committedAmount"}, dependent: "committedAmount", field: {name: "committedAmount", widget: "#DisplayCard", label: "committedAmount", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "retentionPercent"}, dependent: "retentionPercent", field: {name: "retentionPercent", widget: "#DisplayCard", label: "retentionPercent", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "issuedAt"}, dependent: "issuedAt", field: {name: "issuedAt", widget: "#DisplayCard", label: "issuedAt", widgetProps: {icon: "#CalendarDays", format: "date"}}},
        ...
        children: [
            {
                ...
                children: [
                    ...
                    {render: "#Field", field: {name: "budget", widget: "#ApiSelect", label: "form.budgetLabel", placeholder: "form.budgetPlaceholder", skipWriteAccessGate: true, widgetProps: {apiUrl: "/api/realEstate/budget/select", method: "POST", pageSize: 50, normalizeEmptyToUndefined: true}}},
                    ...
                    {render: "#Field", field: {name: "committedAmount", widget: "#Input", label: "form.committedAmountLabel", placeholder: "form.committedAmountPlaceholder", required: true, widgetProps: {type: "number", min: 0, step: "0.01"}}},
                    ...
                    {render: "#Field", field: {name: "issuedAt", widget: "#DateInput", label: "form.issuedAtLabel", placeholder: "form.issuedAtPlaceholder", widgetProps: {valueFormat: "yyyy-MM-dd"}}},
...
export const costCommitmentCreateFormView: ViewConfig = {
    model: "costcommitments", viewType: "form", viewMode: "create", accessModel: "costcommitments",
    apiUrl: "/api/realEstate/costCommitment", method: "PUT", nodes: formNodes,
};

export const costCommitmentEditFormView: ViewConfig = {
    model: "costcommitments", viewType: "form", viewMode: "edit", accessModel: "costcommitments",
    apiUrl: "/api/realEstate/costCommitment", method: "PATCH", nodes: formNodes,
};

export const costCommitmentViews: ViewConfig[] = [costCommitmentSheetView, costCommitmentCreateFormView, costCommitmentEditFormView];
