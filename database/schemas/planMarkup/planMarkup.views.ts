            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#DisplayCard", permissions: {read: "markerType"}, field: {name: "markerType", widget: "#DisplayCard", label: "markerType", widgetProps: {icon: "#IconLabel", languageKeyCategory: "markerTypes"}}},
                        {render: "#DisplayCard", permissions: {read: "page"}, dependent: "page", field: {name: "page", widget: "#DisplayCard", label: "page", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "layer"}, dependent: "layer", field: {name: "layer", widget: "#DisplayCard", label: "layer", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "geometryX"}, dependent: "geometryX", field: {name: "geometryX", widget: "#DisplayCard", label: "geometryX", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "geometryY"}, dependent: "geometryY", field: {name: "geometryY", widget: "#DisplayCard", label: "geometryY", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#DisplayCard", permissions: {read: "createdOnSite"}, field: {name: "createdOnSite", widget: "#DisplayCard", label: "createdOnSite", widgetProps: {icon: "#CircleDot", languageKeyCategory: "onSiteState", variantLookupField: "createdOnSite"}}},
