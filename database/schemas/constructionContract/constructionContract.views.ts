            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#DisplayCard", permissions: {read: "workPackage"}, dependent: "workPackage", field: {name: "workPackage.name", widget: "#DisplayCard", label: "workPackage", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#DisplayCard", permissions: {read: "contractValue"}, dependent: "contractValue", field: {name: "contractValue", widget: "#DisplayCard", label: "contractValue", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#DisplayCard", permissions: {read: "performanceBond"}, dependent: "performanceBond", field: {name: "performanceBond", widget: "#DisplayCard", label: "performanceBond", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "paymentTerms"}, dependent: "paymentTerms", field: {name: "paymentTerms", widget: "#DisplayCard", label: "paymentTerms", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#DisplayCard", permissions: {read: "approvedVariationsTotal"}, dependent: "approvedVariationsTotal", field: {name: "approvedVariationsTotal", widget: "#DisplayCard", label: "approvedVariationsTotal", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "certifiedClaimsTotal"}, dependent: "certifiedClaimsTotal", field: {name: "certifiedClaimsTotal", widget: "#DisplayCard", label: "certifiedClaimsTotal", widgetProps: {icon: "#IconLabel"}}},
