            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "budget"}, dependent: "budget", field: {name: "budget.name", widget: "#SmallInfoCard", label: "budget", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "committedAmount"}, dependent: "committedAmount", field: {name: "committedAmount", widget: "#SmallInfoCard", label: "committedAmount", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "issuedAt"}, dependent: "issuedAt", field: {name: "issuedAt", widget: "#SmallInfoCard", label: "issuedAt", widgetProps: {icon: "#CalendarDays", format: "date"}}},
