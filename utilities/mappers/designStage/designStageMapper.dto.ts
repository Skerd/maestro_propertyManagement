import type {DesignStage} from "armonia/src/modules/propertyManagement/api/realEstate/private/designStage/designStage.dto";
...
export function designStageToDTO(doc: IDesignStage | any): DesignStage {
    ...
    return out as DesignStage;
}

export function designStagesToDTO(docs: IDesignStage[]): DesignStage[] {
    return docs.map(designStageToDTO);
}
