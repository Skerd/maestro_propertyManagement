            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "question"}, dependent: "question", field: {name: "question", widget: "#SmallInfoCard", label: "question", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#SmallInfoCard", permissions: {read: "answer"}, dependent: "answer", field: {name: "answer", widget: "#SmallInfoCard", label: "answer", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#SmallInfoCard", permissions: {read: "dueDate"}, dependent: "dueDate", field: {name: "dueDate", widget: "#SmallInfoCard", label: "dueDate", widgetProps: {icon: "#CalendarDays", format: "date"}}},
                        ...
                        {render: "#SmallInfoCard", permissions: {read: "askedBy"}, dependent: "askedBy", field: {name: "askedBy", widget: "#SmallInfoCard", label: "askedBy", widgetProps: {icon: "#IconUserCheck", parent: "askedBy", valuePath: ["name", "surname"], joinSeparator: " "}}},
                        {render: "#SmallInfoCard", permissions: {read: "answeredBy"}, dependent: "answeredBy", field: {name: "answeredBy", widget: "#SmallInfoCard", label: "answeredBy", widgetProps: {icon: "#IconUserCheck", parent: "answeredBy", valuePath: ["name", "surname"], joinSeparator: " "}}},
