...
export const maintenanceWorkOrderSheetView: ViewConfig = {
    ...
    nodes: [{render: "#SheetGroup", props: {title: "overview"}, children: [{render: "#SheetGrid", props: {columns: 3}, children: [
        ...
        {render: "#DisplayCard", permissions: {read: "plan"}, dependent: "plan", field: {name: "plan.title", widget: "#DisplayCard", label: "plan", widgetProps: {icon: "#IconLabel"}}},
        ...
        {render: "#DisplayCard", permissions: {read: "type"}, dependent: "type", field: {name: "type", widget: "#DisplayCard", label: "type", widgetProps: {icon: "#IconLabel", languageKeyCategory: "types"}}},
        {render: "#DisplayCard", permissions: {read: "assignee"}, dependent: "assignee", field: {name: "assignee.name", widget: "#DisplayCard", label: "assignee", widgetProps: {icon: "#IconLabel"}}},
        {render: "#DisplayCard", permissions: {read: "costEstimate"}, dependent: "costEstimate", field: {name: "costEstimate", widget: "#DisplayCard", label: "costEstimate", widgetProps: {icon: "#IconLabel"}}},
        {render: "#DisplayCard", permissions: {read: "actualCost"}, dependent: "actualCost", field: {name: "actualCost", widget: "#DisplayCard", label: "actualCost", widgetProps: {icon: "#IconLabel"}}},
