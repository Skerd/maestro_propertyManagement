import type {CostCommitment} from "armonia/src/modules/propertyManagement/api/realEstate/private/costCommitment/costCommitment.dto";
...
export function costCommitmentToDTO(doc: ICostCommitment | any): CostCommitment {
    ...
    return out as CostCommitment;
}

export function costCommitmentsToDTO(docs: ICostCommitment[]): CostCommitment[] {
    return docs.map(costCommitmentToDTO);
}
