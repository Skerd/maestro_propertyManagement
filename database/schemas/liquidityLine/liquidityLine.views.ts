            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#DisplayCard", permissions: {read: "period"}, dependent: "period", field: {name: "period", widget: "#DisplayCard", label: "period", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "direction"}, field: {name: "direction", widget: "#DisplayCard", label: "direction", widgetProps: {icon: "#CircleDot", languageKeyCategory: "directions"}}},
