import type {Rfi} from "armonia/src/modules/propertyManagement/api/realEstate/private/rfi/rfi.dto";
...
export function rfiToDTO(doc: IRfi | any): Rfi {
...
export function rfisToDTO(docs: IRfi[]): Rfi[] {
    return docs.map(rfiToDTO);
}
