            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#DisplayCard", permissions: {read: "role"}, dependent: "role", field: {name: "role", widget: "#DisplayCard", label: "role", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "scope"}, dependent: "scope", field: {name: "scope", widget: "#DisplayCard", label: "scope", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#DisplayCard", permissions: {read: "feeAmount"}, dependent: "feeAmount", field: {name: "feeAmount", widget: "#DisplayCard", label: "feeAmount", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#DisplayCard", permissions: {read: "deliverables"}, dependent: "deliverables", field: {name: "deliverables", widget: "#DisplayCard", label: "deliverables", widgetProps: {icon: "#IconLabel"}}},
