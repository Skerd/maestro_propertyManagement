            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#DisplayCard", permissions: {read: "handoverPackage"}, dependent: "handoverPackage", field: {name: "handoverPackage.name", widget: "#DisplayCard", label: "handoverPackage", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "systemName"}, dependent: "systemName", field: {name: "systemName", widget: "#DisplayCard", label: "systemName", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "testDate"}, dependent: "testDate", field: {name: "testDate", widget: "#DisplayCard", label: "testDate", widgetProps: {icon: "#CalendarDays", format: "date"}}},
                        {render: "#DisplayCard", permissions: {read: "resultNotes"}, dependent: "resultNotes", field: {name: "resultNotes", widget: "#DisplayCard", label: "resultNotes", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "inspectedBy"}, dependent: "inspectedBy", field: {name: "inspectedBy", widget: "#DisplayCard", label: "inspectedBy", widgetProps: {icon: "#IconUserCheck", parent: "inspectedBy", valuePath: ["name", "surname"], joinSeparator: " "}}},
