...
export const bimQuantitySheetView: ViewConfig = {
    ...
    nodes: [{render: "#SheetGroup", props: {title: "overview"}, children: [{render: "#SheetGrid", props: {columns: 3}, children: [
        ...
        {render: "#DisplayCard", permissions: {read: "bimModel"}, dependent: "bimModel", field: {name: "bimModel.title", widget: "#DisplayCard", label: "bimModel", widgetProps: {icon: "#IconLabel"}}},
        {render: "#DisplayCard", permissions: {read: "ifcElementType"}, dependent: "ifcElementType", field: {name: "ifcElementType", widget: "#DisplayCard", label: "ifcElementType", widgetProps: {icon: "#IconLabel"}}},
