            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {render: "#DisplayCard", permissions: {read: "workflow"}, dependent: "workflow", field: {name: "workflow.title", widget: "#DisplayCard", label: "workflow", widgetProps: {icon: "#IconLabel"}}},
                        {render: "#DisplayCard", permissions: {read: "targetType"}, field: {name: "targetType", widget: "#DisplayCard", label: "targetType", widgetProps: {icon: "#IconLabel"}}},
                        ...
                        {render: "#DisplayCard", permissions: {read: "currentStage"}, field: {name: "currentStage", widget: "#DisplayCard", label: "currentStage", widgetProps: {icon: "#CircleDot", languageKeyCategory: "stages"}}},
                        {render: "#DisplayCard", permissions: {read: "primaryDecision"}, field: {name: "primaryDecision", widget: "#DisplayCard", label: "primaryDecision", widgetProps: {icon: "#CircleDot", languageKeyCategory: "decisions"}}},
                        {render: "#DisplayCard", permissions: {read: "escalationDecision"}, field: {name: "escalationDecision", widget: "#DisplayCard", label: "escalationDecision", widgetProps: {icon: "#CircleDot", languageKeyCategory: "decisions"}}},
